  ...
  <div class="container-fluid vh-100 bg-login">
    <div class="row vh-100">
      <div class="col-8 h-100">
        <div class="height">
          <p class="fs-1 fw-bold me-4"><span class="black-font">Brainsters</span><span class="gray-font">Preneuers</span></p>
      ...
      <div class="col-4">
          <form class="h-100 d-flex" action="">
            <div class="d-flex w-75 flex-column justify-content-center">
                ...
                <input v-model="password" class="mt-3" type="password" name="password" id="password" placeholder="password">
                <button @click.prevent="login" class="btn btn-rounded w-50 align-self-end mt-3 orange-bg text-light">Login</button>
            </div>
          </form>
      </div>
    </div>
